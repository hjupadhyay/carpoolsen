...
def accept(request):
    ...
    resobj = Reserved.objects.get(pk=resid)
    postobj = resobj.post
    return HttpResponse(jinja_environ.get_template('notice.html').render({"rider":request.user.rider, "text":'Accepted request. Click <a href="/post_page/?key={{postobj.pk}}">here</a> to go back to homepage.'}))
...
def revoke(request):
    ...
    return HttpResponse(jinja_environ.get_template('notice.html').render({"rider":request.user.rider,
                                                                          "text":'<p>Cancelled reservation successfully.</p>\
                                                                              <p>Click <a href="/post_page/?key={{resobj.post.pk}}">here</a> to go back to the post</p>'}))
...
def search_do(request):
    ...
    #return HttpResponse(len(resultlist))
